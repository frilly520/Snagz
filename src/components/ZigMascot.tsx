...
export const ZigAvatar: React.FC<ZigAvatarProps> = ({
  ...
  return (
    ...
    >
      {glow && (
        <div className="absolute inset-0 rounded-full bg-blue-500/30 blur-md pointer-events-none animate-pulse" />
      )}
      <svg
        viewBox="0 0 100 100"
        width={pixelSize}
      ...
      >
        <defs>
          ...
          <linearGradient id="zig-helmet" x1="20" y1="15" x2="80" y2="85" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#1e2436" />
        ...
        <circle cx="50" cy="50" r="47" fill="#0d111c" stroke="#3b82f6" strokeWidth="2.5" strokeOpacity="0.4" />
        ...
        <path
          ...
          fill="#3b82f6"
        />
        <circle cx="50" cy="23" r="2.5" fill="#60a5fa" />
        ...
        {expression === 'hunting' || expression === 'thinking' ? (
          ...
          <g id="scanner-eyes">
            {/* Left Scanner Lens */}
            <circle cx="41" cy="52" r="4.5" fill="#081430" stroke="#93c5fd" strokeWidth="1.2" />
            <circle cx="42" cy="51" r="2.2" fill="#ffffff" />
            
            {/* Right Scanner Lens */}
            <circle cx="59" cy="52" r="4.5" fill="#081430" stroke="#93c5fd" strokeWidth="1.2" />
            <circle cx="60" cy="51" r="2.2" fill="#ffffff" />

            {/* Mischievous wink / HUD tick mark */}
            <line x1="47" y1="52" x2="53" y2="52" stroke="#60a5fa" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
          </g>
        )}
        ...
        {/* CHEEK SENSOR LIGHTS */}
        <circle cx="34" cy="65" r="1.5" fill="#3b82f6" opacity="0.8" />
        <circle cx="66" cy="65" r="1.5" fill="#3b82f6" opacity="0.8" />
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-transform ${
        active 
          ? 'bg-gradient-to-tr from-blue-600 via-blue-500 to-indigo-500 p-[2px] shadow-lg shadow-blue-950 scale-105' 
          : 'bg-gradient-to-tr from-slate-800 to-slate-700 p-[1.5px] hover:border-blue-500'
      }`}>
        <div className="w-full h-full rounded-full bg-[#0d101a] flex items-center justify-center overflow-hidden">
      ...
      <span className="absolute top-0 right-0 flex h-3 w-3">
        ...
        <span className="relative inline-flex rounded-full h-3 w-3 bg-blue-500 border border-[#0d101a]" />
      </span>
    </div>
  );
};
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative">
        <div className="w-10 h-10 rounded-xl bg-[#0d101a] border border-blue-500/40 p-0.5 shadow-md flex items-center justify-center">
          <ZigAvatar size={36} expression="confident" glow />
        </div>
        <span className="absolute -bottom-1 -right-1 w-3.5 h-3.5 rounded-full bg-blue-500 border-2 border-[#0d101a] flex items-center justify-center">
      ...
      <div>
        <div className="flex items-center gap-1.5">
          <h2 className="text-sm font-black text-white tracking-wide flex items-center gap-1">
            <span>ZIG</span>
            <span className="text-[10px] px-1.5 py-0.2 rounded bg-blue-600 text-white font-bold uppercase tracking-wider">
              Deal Hunter
            </span>
          </h2>
        </div>
        <p className="text-[11px] text-blue-400/90 flex items-center gap-1 font-medium">
...
export const ZigThinkingAnimation: React.FC = () => {
  return (
    <div className="flex items-start gap-3 p-3 rounded-xl bg-[#0d101a] border border-blue-500/30 text-slate-300 text-xs shadow-lg">
      <div className="relative shrink-0">
        <ZigAvatar size={36} expression="hunting" glow />
        <div className="absolute inset-0 rounded-full border border-blue-400 animate-ping opacity-30 pointer-events-none" />
      </div>
      <div className="flex-1 min-w-0 py-0.5">
        ...
        <div className="mt-2 flex items-center gap-2 text-[10px] text-blue-400/80 font-mono">
          <span className="px-1.5 py-0.5 rounded bg-[#141926] border border-[#222b3e]">CVS ExtraCare</span>
          <span className="px-1.5 py-0.5 rounded bg-[#141926] border border-[#222b3e]">Target Circle</span>
          <span className="px-1.5 py-0.5 rounded bg-[#141926] border border-[#222b3e]">Ibotta Rebates</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-col items-center text-center p-4 sm:p-6 space-y-4">
      ...
      <div className="relative">
        ...
        <div className="relative w-24 h-24 rounded-2xl bg-[#0d101a] border-2 border-blue-500/50 shadow-2xl flex items-center justify-center p-2">
          <ZigAvatar size={76} expression="confident" glow />
          {/* Magnifying holographic reticle overlay */}
          <div className="absolute -bottom-2 -right-2 bg-blue-600 text-white p-1 rounded-md font-bold text-[9px] flex items-center gap-1 shadow-lg border border-[#0d101a]">
            <span>READY</span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-md space-y-2">
        ...
        <p className="text-xs text-slate-400 leading-relaxed">
          I don't just find coupons—I compute complete <strong className="text-slate-200">Savings Recipes</strong>, check store reward thresholds, uncover <strong className="text-amber-400">Money Makers</strong>, and calculate your exact out-of-pocket register total.
        </p>
      </div>

      {/* Quick Action Prompts */}
      <div className="w-full pt-2">
        <p className="text-[11px] font-bold text-slate-400 text-left mb-2 flex items-center justify-between">
          <span>Quick Deal Inquiries:</span>
          <span className="text-blue-400 font-normal">Tap to ask ZIG</span>
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-left">
          {quickActions.map((qa, i) => (
            <button
              ...
              className="group p-2.5 rounded-lg bg-[#0d101a] hover:bg-[#141926] border border-[#222b3e] hover:border-blue-500/60 transition-all flex items-start gap-2.5 text-left"
            >
              <span className="text-base shrink-0 p-1 rounded-md bg-[#141926] group-hover:bg-blue-950 transition-colors">
                {qa.icon}
              </span>

...
export const SnagzSplashScreen: React.FC = () => {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#0b0d13] select-none transition-opacity duration-300">
      <div className="flex flex-col items-center text-center space-y-4 animate-in fade-in zoom-in-95 duration-200">
        <SnagzSymbol size={72} className="shadow-2xl shadow-blue-500/20" />
        <div className="space-y-1.5">
          <h1 className="text-3xl font-black tracking-tight text-white font-sans">
            SNAG<span className="text-blue-500">Z</span>
          </h1>
          <p className="text-xs font-bold uppercase tracking-widest text-blue-400" style={{ letterSpacing: '0.2em' }}>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 text-center select-none">
      <div className="relative mb-4">
        <SnagzSymbol size={48} className="animate-pulse shadow-lg shadow-blue-500/10" />
        <span className="absolute -inset-1 rounded-2xl bg-blue-500/20 animate-ping -z-10 opacity-40 pointer-events-none" />
      </div>
      <div className="space-y-1">
        <div className="text-sm font-black tracking-wide text-white flex items-center justify-center gap-1">
          <span>SNAG</span><span className="text-blue-500">Z</span>
        </div>
